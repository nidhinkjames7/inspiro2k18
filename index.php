...
<html>
  ...
  <body class="appear-animate">
    ...
    <div class="page-loader">
      <div class="loader">Loading</div><span class="loader-text alt-font">INSPIRO</span>
    </div>
    <!--Page Lader End-->
    <div id="top"></div>
    <!-- Navigation panel-->
      ...
      <div class="full-wrapper relative clearfix">
        ...
        <div class="inner-nav navbar-desktop">
          <ul class="clearlist scroll scroll-nav">
            ...
            <li><a href="#team">What People Say?</a></li>
 ...
 <div class="wrapper">
            <ul class="scene unselectable" id="scene">
          ...
          <div class="row mt-60 mt-xs-30">
            <div class="col-md-8 col-md-offset-2 text-center">
              <blockquote data-wow-delay="0.1s" data-wow-duration="1s" class="about-quote wow fadeInUp">
                <p>
					<b>Inspiro</b>, the most coveted intercollegiate national level festival is organized by the MCA association of DON BOSCO Coleege every year.
				</p>
                <footer class="about-quote-author">Team INSPIRO</footer>
              </blockquote>
            </div>
          </div>
        </div>
        <div id="facts" class="small-section bg-light mt-80 mt-xs-80">
          <div class="container">
            ...
            <div class="row mt-60">
              ...
              <div class="col-md-3 col-sm-6 text-center">
                <div class="fact-item">
                    <div class="fact-number"><span class="icon-target"></span><span class="focus-number">30</span><span> + </span></div>
                  <h5 class="fact-desc alt-font">College Participations</h5>
                </div>
              </div>
              <div class="col-md-3 col-sm-6 text-center">
                <div class="fact-item">
                  <div class="fact-number"><span class="icon-briefcase"></span><span class="focus-number">8</span><span>+</span></div>
        ...
        <div class="container">
          ...
          <div class="row mt-60 mt-xs-30">
            <div class="col-md-8 col-md-offset-2 text-center">
			  ...
			  <div class="col-sm-4 contact-item"><span class="icon-phone"></span>
                <p><b>Staff Coordinator</b><br>Diljith K Benny<br> +91 9567738713<br>dkb.jithu@gmail.com</p>
              </div>
          </div>
        </div>
        <!--Google maps-->
        <div class="google-map">
          <div id="map-canvas" data-address="12.032204, 75.740093"></div>
